...
const testimonials = [
  ...
  {
    name: "المتدربة علا شيلباية",
    role: "صيدلانية وسيدة أعمال",
    quote:
      "دكتوره ايات عوده امسكت بذراعي الى طريق النسخه الافضل مني وحماية ذاتي وقلبي طريق ابصر النور بقترة قصيره بفضل مجهود دكتوره ايات التي ادارات بصيرتي نحو ذاتي المضيئه لارى العالم بطريقه افضل واكون انسان ناجح وسيدة اعمال في المجتمع والعالم . شكرا دكتوره آيات من اعماق قلبي.",
  },
] as const;
